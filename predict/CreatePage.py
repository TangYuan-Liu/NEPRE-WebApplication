...
def createWaitPage(ID):
    ...
    """
    print'</div>'
    print'<div class="form-group" style = "margin-left:80px; margin-top:40px; margin-right:940px">'
    print'<fieldset disabled="">'
    print'<label class="control-label" for="disabledInput">Process ID</label>'
    print'<input class="form-control" id="disabledInput" type="text" placeholder="' + str(ID) + '" disabled="">'
    print'</fieldset>'
    print'</div>'
    """
    print'<div style = "margin-left:80px; margin-top:40px">'
    print'<p>Congradulations! Your job has been submitted successfully.</p>' 
    print'<p>Online system is calculating the results, please wait. It will take several minutes to finish.</p>'
    print'</div>'
    ...
    print'<strong>Want to see Results?!</strong> Click to get<a href=' + '"/checkResults/"' + 'class="alert-link"> results.</a>'
    print'</div>'
    print'</div>'
...
def createResultPage(ID, energylist, namelist, folder_path):
    ...
    print'<h4 style = "color:cornflowerblue">Job Information</h4>'
    print'<hr></hr>'
    print'<p><b>Process ID:</b> {{ id }}</p>'
    print'<p><b>Total Structures Amount: </b>' + str(decoy_num) + '</p>'
    print'<p><b>Submit Time:</b> {{ submit_time }}</p>'
    print'</div>'
    print'<div style = "margin-left:80px; margin-top:20px; margin-right:80px">'
    print'<h4 style = "color:cornflowerblue">Top10 Decoy Energy List</h4>'
    print'<hr></hr>'
    ...
    print'<hr></hr>'
    print"<p><b>The prediction is: </b>" + new_dict[0][0] + "</p>"
    print'</div>'
